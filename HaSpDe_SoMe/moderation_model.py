...
class ModerationModel:
    def __init__(self, learns=True, human_review=False, strict_anti_profane=False, certainty_needed=85):
        ...
        if self.certainty_needed <= 79:
            logger.error("YOU FUCKING IDIOT! IM NOW KILLING MYSELF CUZ OF YOU! PUT CERTAINTY_NEEDED TO BE OVER 80!")
            exit()
